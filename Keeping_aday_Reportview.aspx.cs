...
public partial class Keeping_aday_Reportview : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Keeping_aday_Viewer.LocalReport.DataSources.Clear();
        //Keeping_aday_Viewer.LocalReport.ReportPath = Server.MapPath("Feeds_Aday.rdlc");
        //
        //Microsoft.Reporting.WebForms.ReportParameter p_1 = new Microsoft.Reporting.WebForms.ReportParameter("Feed_Time", "paladin");
        //Keeping_aday_Viewer.LocalReport.SetParameters(new Microsoft.Reporting.WebForms.ReportParameter[] { p_1});
        //
        //Keeping_aday_Viewer.LocalReport.Refresh();

            //ReportParameter Feed_Time = new ReportParameter("Feed_Time", str1);//打印客戶名稱
            //this.Keeping_aday_Viewer.LocalReport.SetParameters(new ReportParameter[] { Feed_Time });
            //this.Keeping_aday_Viewer.LocalReport.Refresh();//重整
...
*/
    /*篩選所有資料     SELECT Feed.Pool_id,Feed.date,Feed.Fish_detail_id,SUM(medicine_number) AS medicine_number, 
